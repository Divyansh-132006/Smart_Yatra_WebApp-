...
//   // --- Font Loading ---
//   // This hook loads the fonts and tells us when they are ready.
...
//       animation: require("../../../assets/images/Traveler.json"),
...
//       animation: require("../../../assets/images/map navigation.json"),
...
//       animation: require("../../../assets/images/Sos Notification.json"),
...
//     //   finalTagline: "Because every tourist deserves a safe journey.",
//       animation: require("../../../assets/images/Login Leady.json"),
...
//    lastSlideContainer: {
//     position: 'absolute',
//     bottom: 60, // Position the buttons towards the bottom
//     width: '100%',
//     alignItems: 'center',
//   },
//   getStartedButton: {
...
//     color: '#3395ff', // Match the background color of the slide
//     fontSize: 18,
//     fontFamily: 'Poppins-Bold',
//   },
//   loginContainer: {
...
const Intro = ({ navigation }) => {
  const slides = [
    {
      ...
      title: 'Welcome to SmartYatra',
      tagline: 'Your trusted companion for every journey.',
      bodyText: 'Travel with confidence knowing that your safety is our priority. Explore new destinations with peace of mind.',
    ...
    },
    {
      key: '2',
      title: 'Stay Aware, Stay Safe',
      bodyText: 'Receive AI-driven real-time safety monitoring and get instant geo-fencing alerts if you approach dangerous or restricted zones.',
    ...
    },
    {
      key: '3',
      title: 'Help is Just a Tap Away',
      bodyText: 'In an emergency, use the one-tap SOS to instantly connect with the nearest police, hospitals, and tourism authorities.',
    ...
    },
    {
      key: '4',
      title: 'Your Secure Digital Travel ID',
      bodyText: 'Create a secure, tamper-proof digital identity using our blockchain technology for frictionless and private check-ins.',
      animation: require('../../../assets/animation/Login Leady.json'),
      backgroundColor: '#3395ff',
    },
  ];

  // Fixed: Handle navigation properly for different scenarios
  const handleDone = () => {
    // Navigate to UserTypeSelection for signup flow
    navigation.navigate("UserTypeSelection");
  };

  const handleGetStarted = () => {
    // Navigate to UserTypeSelection for new users
    navigation.navigate("UserTypeSelection");
  };
  ...
  const handleSkip = () => {
    // Skip intro and go to UserTypeSelection
    navigation.navigate("UserTypeSelection");
  };
  ...
  const _renderItem = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        {/* Fixed: Custom buttons for last slide */}
        {item.key === "4" && (
          <View style={styles.lastSlideContainer}>
            <TouchableOpacity 
  ...
  return (
    <SafeAreaProvider>
      <AppIntroSlider
        ...
        renderDoneButton={_renderDoneButton}
        renderSkipButton={_renderSkipButton}
        // Fixed: Hide default buttons on last slide since we have custom ones
...
const styles = StyleSheet.create({
  ...
  lastSlideContainer: {
    position: 'absolute',
    bottom: 80, // Increased bottom margin to avoid overlap
    width: '100%',
    alignItems: 'center',
  ...
  getStartedButton: {
    ...
    shadowRadius: 5,
    elevation: 8,
    minWidth: 200, // Ensure button has minimum width
  },
  getStartedButtonText: {
    color: '#3395ff',
    fontSize: 18,
